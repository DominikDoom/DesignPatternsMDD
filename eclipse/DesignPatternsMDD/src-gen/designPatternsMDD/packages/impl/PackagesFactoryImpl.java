...
public class PackagesFactoryImpl extends EFactoryImpl implements PackagesFactory {
	...
	public static PackagesFactory init() {
		try {
			PackagesFactory thePackagesFactory = (PackagesFactory) EPackage.Registry.INSTANCE
					.getEFactory(PackagesPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case PackagesPackage.PACKAGES_ROOT:
			return createPackagesRoot();
		default:
	 ...
	 * @generated
	 */
	public PackagesRoot createPackagesRoot() {
		PackagesRootImpl packagesRoot = new PackagesRootImpl();
		return packagesRoot;
	}
