...
public class PatternsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PatternsPackage.PATTERN_ROOT: {
			PatternRoot patternRoot = (PatternRoot) theEObject;
			T result = casePatternRoot(patternRoot);
			if (result == null)
		...
		case PatternsPackage.SINGLETON_PATTERN: {
			SingletonPattern singletonPattern = (SingletonPattern) theEObject;
			T result = caseSingletonPattern(singletonPattern);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case PatternsPackage.OBSERVER_PAIR: {
			ObserverPair observerPair = (ObserverPair) theEObject;
			T result = caseObserverPair(observerPair);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T casePatternRoot(PatternRoot object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Singleton Pattern</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Singleton Pattern</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSingletonPattern(SingletonPattern object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Observer Pair</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Observer Pair</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
