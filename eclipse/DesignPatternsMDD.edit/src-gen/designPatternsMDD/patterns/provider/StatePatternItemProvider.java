	...
	protected void addStateClassesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_StatePattern_StateClasses_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_StatePattern_StateClasses_feature",
								"_UI_StatePattern_type"),
						PatternsPackage.Literals.STATE_PATTERN__STATE_CLASSES, true, false, true, null, null, null));
	}
